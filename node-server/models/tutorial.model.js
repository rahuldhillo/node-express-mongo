...
Tutorial.prototype.create = (newTutorial, result) => {
...
Tutorial.prototype.findById = (id, result) => {
...
Tutorial.prototype.getAll = (title, result) => {
...
Tutorial.prototype.getAllPublished = result => {
...
Tutorial.prototype.updateById = (id, tutorial, result) => {
  connection.query(
...
Tutorial.prototype.remove = (id, result) => {
...
Tutorial.prototype.removeAll = result => {
